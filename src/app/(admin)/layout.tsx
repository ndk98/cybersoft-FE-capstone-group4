                        ...
                        <ul id="dropdown-example" className="hidden py-2 space-y-2">
                            <li>
                                <Link href="/admin/location/list"
                                   className="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-slate-700">Danh sách vị trí</Link>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul id="dropdown-user" className="hidden py-2 space-y-2">
                            <li>
                                <Link href="/admin/user/list"
                                   className="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-slate-700 ">Danh sách người dùng</Link>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul id="dropdown-room" className="hidden py-2 space-y-2">
                            <li>
                                <Link href="/admin/room/list"
                                   className="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-slate-700">Danh sách phòng</Link>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul id="dropdown-booking" className="hidden py-2 space-y-2">
                            <li>
                                <Link href="/admin/booking/list"
                                   className="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-slate-700">Danh sách đặt phòng</Link>
                            </li>
                        </ul>
                    </li>
                </ul>
