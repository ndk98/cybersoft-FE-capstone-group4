                ...
                <ul className="space-y-2 font-medium">
                        ...
                        >
                            <li>
                                <Link
                                    ...
                                    className="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-slate-700"
                                >
                                    Danh sách vị trí
                                </Link>
                            </li>
                    ...
                    <li>
                        <button
                            ...
                            data-collapse-toggle="dropdown-room"
                        >
                            <span className="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">
                                Phòng
                            </span>
                    ...
                    <li>
                        <button
                            type="button"
                            className="flex items-center w-full p-2 text-base text-white transition duration-75 rounded-lg group hover:bg-slate-700"
                            aria-controls="dropdown-booking"
                            data-collapse-toggle="dropdown-booking"
                        >
                            <span className="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">
                                Đặt phòng
                            </span>
